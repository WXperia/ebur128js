...
export class LoudnessMeter {
    ...
    private async sendToWorker(task: InputData["task"], buffer: AudioBuffer, targetLoudness?: number, maxTruePeak?: number, tolerance?: number) {
    ...
    loudnessMatch = async (buffer: AudioBuffer, targetLoudness?: number, maxTruePeak?: number, tolerance?: number) => {
        return await this.sendToWorker("loudnessMatch", buffer, targetLoudness, maxTruePeak, tolerance)
    }
}
